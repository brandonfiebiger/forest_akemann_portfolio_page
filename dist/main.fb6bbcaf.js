...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../.nvm/versions/node/v10.0.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../.nvm/versions/node/v10.0.0/lib/node_modules/parcel-bundler/node_modules/process/browser.js"}],"node_modules/gsap/TweenLite.js":[function(require,module,exports) {
var global = arguments[3];
"use strict";
...
function (_Highway$Transition) {
  _inherits(SlideUp, _Highway$Transition);

  function SlideUp() {
    _classCallCheck(this, SlideUp);

    return _possibleConstructorReturn(this, _getPrototypeOf(SlideUp).apply(this, arguments));
  }
  ...
  _createClass(SlideUp, [{
    ...
    value: function _in(_ref) {
      ...
      }).fromTo(to.children[1], .08, {
        height: '100vh'
      }, {
        height: '55vh'
      }, '+=.5').fromTo(to.children[1].children[1], .2, {
        opacity: '0'
      }, {
        opacity: '1'
...
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","gsap":"node_modules/gsap/index.js"}],"js/slide_up_no_fade.js":[function(require,module,exports) {
"use strict";
...
/*#__PURE__*/
function (_Highway$Transition) {
  _inherits(SlideUpNoFade, _Highway$Transition);

  function SlideUpNoFade() {
    _classCallCheck(this, SlideUpNoFade);

    return _possibleConstructorReturn(this, _getPrototypeOf(SlideUpNoFade).apply(this, arguments));
  }

  _createClass(SlideUpNoFade, [{
    key: "in",
    // responsible for page coming in
    value: function _in(_ref) {
      var from = _ref.from,
      ...
      }, '0').fromTo(to.children[0].children, .00, {
        opacity: '0'
      }, {
        opacity: '1'
      }, '0') // .fromTo(to.children[0].children[1], .00, { opacity: '0' }, { opacity: '1' }, '0')
      .fromTo(to.children[1], .00, {
        opacity: '0',
        display: 'none'
      }, {
        opacity: '1',
        display: 'flex'
      }, '0').fromTo(to.children[1].children, .00, {
        opacity: '0'
      }, {
        opacity: '1'
      }, '0'); // .fromTo(to.children[1].children[1], .2, {opacity: '0'}, {opacity: '1'}, '+=.75')
  ...
  return SlideUpNoFade;
}(_highway.default.Transition);

var _default = SlideUpNoFade;
exports.default = _default;
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","gsap":"node_modules/gsap/index.js"}],"js/slide_up_about_page.js":[function(require,module,exports) {
"use strict";
...
var SlideUpAboutPage =
/*#__PURE__*/
function (_Highway$Transition) {
  _inherits(SlideUpAboutPage, _Highway$Transition);

  function SlideUpAboutPage() {
    _classCallCheck(this, SlideUpAboutPage);

    return _possibleConstructorReturn(this, _getPrototypeOf(SlideUpAboutPage).apply(this, arguments));
  }

  _createClass(SlideUpAboutPage, [{
    key: "in",
    // responsible for page coming in
    value: function _in(_ref) {
      var from = _ref.from,
...
var _slide_up_no_fade = _interopRequireDefault(require("./slide_up_no_fade"));
...
$(document).ready(function () {
  ...
  var tags = ['lunaire', 'zogra', 'hawaii'];
  var times = [4000, 4500, 5000];

  var _loop = function _loop(i) {
    setTimeout(function () {
      if (tags[i] !== 'lunaire') {
        $(".".concat(tags[i])).addClass('translate_y');
      }

      $(".".concat(tags[i])).addClass('visible');
    }, times[i]);
  };
...
},{"@dogstudio/highway":"node_modules/@dogstudio/highway/build/highway.js","gsap":"node_modules/gsap/index.js","./slide_up":"js/slide_up.js","./slide_up_no_fade":"js/slide_up_no_fade.js","./slide_up_about_page":"js/slide_up_about_page.js"}],"../.nvm/versions/node/v10.0.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../.nvm/versions/node/v10.0.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/main.js"], null)
