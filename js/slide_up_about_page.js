...
class SlideUpAboutPage extends Highway.Transition {
  ...
  in({ from, to, done }) {
    ...
    .fromTo(to.children[1].children[2].children[0].children[0], .2, { opacity: '0' }, { opacity: '1' }, '2')
    .fromTo(to.children[1].children[2].children[0].children[1], .5, { opacity: '0' }, { opacity: '1' }, '4')
    .fromTo(to.children[1].children[2].children[1], .5, { opacity: '0' }, { opacity: '1' }, '4')
